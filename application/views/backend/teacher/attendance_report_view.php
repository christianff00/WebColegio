...
<div class="row">
    ...
    <div class="col-md-2">
        <div class="form-group">
            <label class="control-label" style="margin-bottom: 5px;"><?php echo get_phrase('select_year'); ?></label>
...
<?php if ($class_id != '' && $section_id != '' && $month != '' && $sessional_year != ''): ?>
    ...
    <div class="row">
        <div class="col-md-12">
            <table class="table table-bordered" id="my_table">
                ...
                <tbody>
                    ...
                    foreach ($students as $row):
                        $name_student = $this->db->get_where('student', array('student_id' => $row['student_id']))->row()->name;
                        ?>
                        <tr>
                            <td style="text-align: center;">
                                <a href="javascript:;" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/modal_attendance_detail_student/<?php echo $row['student_id']; ?>')"  >
                                    <span> 
            ...
            <center>
                <a href="<?php echo base_url(); ?>index.php?teacher/attendance_report_print_view/<?php echo $class_id; ?>/<?php echo $section_id; ?>/<?php echo $month; ?>/<?php echo $sessional_year; ?>"
                   class="btn btn-primary" target="_blank">
                    <?php echo get_phrase('Imprimir hoja de asistencia'); ?>
                </a>
            </center>
        </div>
    </div>
